...
class IMFriendsScreen extends Component {
  ...
  static navigationOptions = ({ screenProps, navigation }) => {
    ...
    let headerTitle = navigation.state.params.friendsScreenTitle || IMLocalized('Friends');
    ...
    return {
      ...
      headerLeft: showDrawerMenuButton && (
        <TNTouchableIcon
          imageStyle={{ tintColor: AppStyles.navThemeConstants.light.fontColor }}
  ...
  render() {
    const emptyStateConfig = {
      ...
      description: IMLocalized("Make some friend requests and have your friends accept them. All your friends will show up here."),
